...
$(document).on('click tap touchstart', '.menu-icon', function(){
    $('.bottom-header, .menu-icon').toggleClass('active');
});
$(document).on('show.bs.modal hidden.bs.modal', '.modal', function(){
    $('.bottom-header').toggleClass('open-modal');
});
